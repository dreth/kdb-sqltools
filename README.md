...
- Built-in uPlot-powered charting from the current kdb results panel with extension-side downsampling, optional categorical group-by for line/scatter/step/bar charts, cursor tooltips, drag zoom, explicit zoom refinement, reset zoom, splitter resizing, legend toggling, and PNG export.
